...
GLfloat resetVertices[] = {
	// X         Y            R     G     B     U     V
	0.438f, 0.112f,  1.0f, 1.0f, 1.0f, 0.0f, 0.0f, // Bottom-left
	0.438f, 0.146f,  1.0f, 1.0f, 1.0f, 0.0f, 1.0f, // Top-left
	0.582f, 0.146f,  1.0f, 1.0f, 1.0f, 1.0f, 1.0f, // Top-right
	0.582f, 0.112f,  1.0f, 1.0f, 1.0f, 1.0f, 0.0f  // Bottom-right
};
...
int main()
{
	...
	VAO resetVAO;
	resetVAO.Bind();
	setupObject(resetVAO, resetVertices, sizeof(resetVertices), resetIndices, sizeof(resetIndices));
...
#define CRES 100 // Circle Resolution = Rezolucija kruga
	...
	Texture resetButton("../images/reset.png", GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
	resetButton.assignUnit(defaultShader, "tex9", 9);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		if (deltaTime >= TARGET_FRAME_TIME) {
			...
			drawObject(resetButton, resetVAO);
